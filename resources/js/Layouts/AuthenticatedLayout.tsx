...
export default function Authenticated({
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 md:grid">
            <header className="w-full mx-auto flex items-center justify-between p-4 md:justify-between md:bg-white/70 md:shadow-sm">
            ...
            <span className="md:flex md:items-start md:justify-center">
                <span className="hidden md:flex fixed left-0 px-10 py-2 h-screen flex-col gap-5 border bg-white">
                    <Link
                        href={route("dashboard.index")}
                        className="flex items-center justify-center w-full px-5 rounded-md text-white bg-[#5CA4C5] dark:text-black dark:bg-white"
                    >
